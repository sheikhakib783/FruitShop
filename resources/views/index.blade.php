...
<body>
	...
	<!-- jquery -->
	<script src="{{asset('fontend/js/jquery-1.11.3.min.js')}}"></script>
	<!-- bootstrap -->
	<script src="{{asset('fontend/bootstrap/js/bootstrap.min.js')}}"></script>
	<!-- count down -->
	<script src="{{asset('fontend/js/jquery.countdown.js')}}"></script>
	<!-- isotope -->
	<script src="{{asset('fontend/js/jquery.isotope-3.0.6.min.js')}}"></script>
	<!-- waypoints -->
	<script src="{{asset('fontend/js/waypoints.js')}}"></script>
	<!-- owl carousel -->
	...
	<!-- sticker js -->
	<script src="{{asset('fontend/js/sticker.js')}}"></script>
	<!-- main js -->
